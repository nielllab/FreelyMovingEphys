...
def make_population_summary(df1, savepath):
    ...
    crfs0 = np.zeros([len(df1['fm1_crf_tuning'][df1['waveform_km_label']==0]),11])
    crfs1 = np.zeros([len(df1['fm1_crf_tuning'][df1['waveform_km_label']==1]),11])
    for i in range(len(df1['fm1_crf_tuning'][df1['waveform_km_label']==0])):
        try:
            crfs0[i,:] = df1['fm1_crf_tuning'][df1['waveform_km_label']==0][i]
        except:
            pass
    for i in range(len(df1['fm1_crf_tuning'][df1['waveform_km_label']==1])):
        try:
            crfs1[i,:] = df1['fm1_crf_tuning'][df1['waveform_km_label']==1][i]
        except:
            pass
