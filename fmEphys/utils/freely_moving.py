"""
fmEphys/utils/freely_moving.py

Freely moving in light conditions.
...
class FreelyMovingLight(fme.Ephys):
    ...
    def analyze(self):
        ...
        self.detail_pdf = PdfPages(os.path.join(self.recording_path,
                                  '{}_detailed_analysis_figures.pdf'.format(self.recording_name)))
        self.diagnostic_pdf = PdfPages(os.path.join(self.recording_path,
                                   '{}_diagnostic_analysis_figures.pdf'.format(self.recording_name)))
