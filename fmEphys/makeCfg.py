...
def makeCfg():
    ...
    parser.add_argument('-t', '--usetemplate', type=str, default='ephys_cfg')
    ...
    readpath = os.path.join(fmEphys.up_dir(__file__, 2), 'config/{}.yaml'.format(usetemplate))

    shutil.copyfile(readpath, savedir)
