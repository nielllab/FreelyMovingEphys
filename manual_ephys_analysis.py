...
def get_args():
    ...
    parser.add_argument('--ch_count', type=int, default=64, choices=[16, 64], help='number of channels on the ephys probe')
    args = parser.parse_args()
    return args

def main(args):
    # organize a dictionary of inputs
    file_dict = find_files(args.data_path, args.rec_name, args.fm, args.unit, args.stim_type, args.write_mp4, args.ch_count)
    # run the analysis
