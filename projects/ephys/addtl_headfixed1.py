...
class AddtlHF:
    def __init__(self, base_path):
        ...
        self.Sn_ephys = pd.read_hdf(find('*_ephys_props.h5',base_path)[0])
        ...
        self.Sn_world = xr.open_dataset(find('*_world.nc', base_path)[0])
...
def main():
    ...
    #     '020522/J577RT'
    # ]
    recordings = ['/home/niell_lab/Desktop/060122_Sn/hf2_sparsenoiseflash']
    # for i, r in enumerate(recordings):
        # recpath = os.path.join(base_path, r)
    for i, recpath in enumerate(recordings):
