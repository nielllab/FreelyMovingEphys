    ...
    for dir_name in recordings_dict:
        ...
        try:
            ...
            for i in range(len(eye_sides)):
                ...
                print('tracking ' + eye_side + 'EYE for ' + recording_name)
                ...
                if config['save_nc_vids'] is True and config['run_pupil_rotation'] is True:
                    ...
                    trial_eye_data.to_netcdf(os.path.join(config['recording_path'], str(recording_name+'_'+eye_side+'eye.nc')), engine='netcdf4', encoding={eye_side+'EYE_video':{"zlib": True, "complevel": 4}})
        ...
        try:
            ...
            for i in range(0,len(world_sides)):
                ...
                print('tracking '+ world_side +' for ' + recording_name)
